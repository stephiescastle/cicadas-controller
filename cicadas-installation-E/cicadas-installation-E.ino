...
// BROOD E values
// 1270	25	120	3400	FALSE	12
long defaultTimeScale = 1270; // 1000
unsigned long defaultSleepTime = 25; // 10
unsigned long defaultAwakeTime = 120; // 24
unsigned long defaultRampBasis = 3400; // 6000
bool awake = false;
int strongBroodRate = 12;
...
long variedIntensity() {
  if (!strongBrood()) {
    ...
    return random(constrain(intensityMax-40, intensityMin, intensityMax), intensityMax+1);
  }
}
...
void setup() {
  ...
  intensityMax = map(knobValue[1], 0, 1023, 0, 255);
