...
// BROOD C values
// 1270	20	95	2000	TRUE	13
long defaultTimeScale = 1270; // 1000
unsigned long defaultSleepTime = 20; // 10
unsigned long defaultAwakeTime = 95; // 24
unsigned long defaultRampBasis = 2000; // 6000
bool awake = true;
int strongBroodRate = 13;
