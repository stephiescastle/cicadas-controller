...
// BROOD B values
// 1270	32	87	4884	FALSE	11
long defaultTimeScale = 1270; // 1000
unsigned long defaultSleepTime = 32; // 10
unsigned long defaultAwakeTime = 87; // 24
unsigned long defaultRampBasis = 4884; // 6000
bool awake = true;
int strongBroodRate = 11;
